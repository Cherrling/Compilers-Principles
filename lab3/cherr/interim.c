    ...
    while (temp != NULL) {
        ...
        if (temp -> kind == ILABEL) {
            ...
            if (temp1 == NULL || temp2 == NULL) judge_is_null = 1;
                ...
                printf("*t%d", temp1 -> u_int);
                printf(" := ");
                printf("*t%d", temp2 -> u_int);
            } else if (temp2 -> kind == ADDRESS) {
                printf("t%d", temp1 -> u_int);
                printf(" := ");
                printf("*t%d", temp2 -> u_int);
                ...
                printf("&t%d", temp1 -> u_int);
                printf(" := ");
                if (temp2 -> kind == CONSTANT) printf("#%d", temp2 -> u_int);
                else printf("t%d", temp2 -> u_int);
            } else {
                printf("t%d", temp1 -> u_int);
                printf(" := ");
                if (temp2 -> kind == CONSTANT) printf("#%d", temp2 -> u_int);
            ...
            if (temp1 != NULL) {
                ...
                if (temp -> kind == ADD) printf(" + ");
                else if (temp -> kind == SUB) printf(" - ");
                else if (temp -> kind == MUL) printf(" * ");
                else if (temp -> kind == DIV) printf(" / ");
                if (temp3 -> kind == CONSTANT) printf("#%d", temp3 -> u_int);
                else printf("t%d", temp3 -> u_int);
            }
        } else if (temp -> kind == ADDRASS2){
            Operand temp1 = temp -> u.uassign.op1;
            Operand temp2 = temp -> u.uassign.op2;
            ...
            Operand re = temp -> u.uif .relop;
            printf("IF  ");
            if (temp1 -> kind == CONSTANT) printf("#%d", temp1 -> u_int);
            else if (temp1 -> kind == ADDRESS) printf("*t%d", temp1 -> u_int);
            else printf("t%d", temp1 -> u_int);
            ...
            if (temp2 -> kind == CONSTANT) printf("#%d", temp2 -> u_int);
            else if (temp2 -> kind == ADDRESS) printf("*t%d", temp2 -> u_int);
            else printf("t%d", temp2 -> u_int);
            printf(" GOTO label");
            printf("%d", temp3 -> u_int);
        } else if (temp -> kind == RETURN) {
            printf("RETURN ");
            ...
            Operand temp1 = temp -> u.uassign.op1;
            Operand temp2 = temp -> u.uassign.op2;
            if (temp1!=NULL) printf("t%d := ", temp1 -> u_int);
            else{
                Operand temp0 = new_temp();
                printf("t%d := ", temp0 -> u_int);
            }
            printf("CALL ");
            printf("%s", temp2 -> u_char);
        } else if (temp -> kind == PARAM){
            printf("PARAM ");
            if (temp -> u.ulabel.op -> kind == CONSTANT) printf("#%d", temp -> u.ulabel.op -> u_int);
            else printf("t%d", temp -> u.ulabel.op -> u_int);
